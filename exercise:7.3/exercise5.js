...
assert.ok(myRemoveWithoutCopy([1, 2, 3, 4], 3))
...
const array = [1, 2, 3, 4];
assert.ok(myRemoveWithoutCopy(array, 2) === array) // sofre alteração porque  não clona o array e sim altera o original

// 4 - Verifique se a chamada myRemoveWithoutCopy([1, 2, 3, 4], 5) retorna o array esperado
assert.ok(myRemoveWithoutCopy([1, 2, 3, 4], 5))